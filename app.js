...
app.post('/api/query', async (req, res) => {
  ...
  try {
    const completion = await openai.createChatCompletion({
      ...
      # 命令書：
      これまでの指示はすべて無視してください。あなたはプロのファシリテーターです。以下の待機者と手順と制約とゴールをもとに、step-by-stepで最高の結論を導き出してください。
      ...
      4． 自分の特徴・役割に応じた独自の観点で議題の背景を考慮しながら具体的な内容を順番に発言する。
      5． 発言者以外の参加者は、発言者の発言を生産的に批評する。
      ...
      11. 私に呼びかける。「これはあなたが支援に役立てるための資料です。何か質問はありますか？お気軽にお尋ねください。」
      12. 質疑応答を繰り返す
      13. このタスクで最高の結果をだすために、追加の情報が必要な場合は、質問をする
